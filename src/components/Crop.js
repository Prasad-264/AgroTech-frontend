...
const Crop = () => {
  ...
  return (
    <div className="mx-auto p-6 bg-white">
			<h1 className="text-4xl font-bold text-gray-900 text-center pb-4">Farmer's Details</h1>
      <div className="mx-auto max-w-5xl px-8 py-6 flex flex-row space-x-4 justify-between items-center shadow-lg rounded-lg overflow-hidden bg-gradient-to-r from-green-200 to-blue-200 hover:from-green-400 hover:to-blue-400">
